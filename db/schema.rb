...
ActiveRecord::Schema.define(version: 20141204105908) do
  ...
  create_table "artykuls", force: true do |t|
    ...
    t.text     "zawartosc"
    t.string   "zdjecia_file_name"
    t.string   "zdjecia_content_type"
    t.integer  "zdjecia_file_size"
    t.datetime "zdjecia_updated_at"
  ...
  create_table "uzytkowniks", force: true do |t|
    ...
    t.string   "telefon",         limit: 100, default: "", null: false
